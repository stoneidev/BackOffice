...
public class ProductCommentSteps {
    ...
    public void 리뷰가_성공적으로_저장되어야_한다() {
        ...
        assertNotNull(productComment.getId());
    }
    ...
    public void 리뷰_내용을_수정하면(String author, String newContent) {
        productCommentUseCase.updateProductComment(productComment.getId(), newContent);
    }

    @Then("리뷰 내용이 성공적으로 수정되어야 한다")
    public void 리뷰_내용이_성공적으로_수정되어야_한다() {
        ProductComment updatedComment = productCommentUseCase.getProductComment(productComment.getId());
    ...
    public void 관리자가_리뷰를_삭제하면() {
        productCommentUseCase.deleteProductComment(productComment.getId());
    }

    @Then("리뷰가 성공적으로 삭제되어야 한다")
    public void 리뷰가_성공적으로_삭제되어야_한다() {
        assertNull(productCommentUseCase.getProductComment(productComment.getId()));
    }
    ...
    public void 리뷰에_댓글을_작성하면(String author, String comment) {
        ...
        productCommentUseCase.updateProductComment(productComment.getId(), updatedContent);
    }
