...
public class ProductAdapter {
    ...
    @Operation(summary = "Update product price", description = "This endpoint updates the price of an existing product.")
    @PutMapping("/{id}/price")
    public ResponseEntity<Void> updateProductPrice(@PathVariable Long id, @RequestBody Long newPrice) {
        productUseCase.updateProductPrice(id, newPrice);
        return ResponseEntity.ok().build();
    }
}
